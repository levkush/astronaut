...
import dev.levkush.astronaut.features.gui.font.CustomFont;
...
public class TextManager
    ...
    public void init(boolean startup) {
        FontMod cFont = Astronaut.moduleManager.getModuleByClass(FontMod.class);
        try {
    ...
    public void drawString(String text, float x, float y, int color, boolean shadow) {
        if (Astronaut.moduleManager.isModuleEnabled(FontMod.getInstance().getName())) {
            if (shadow) {
