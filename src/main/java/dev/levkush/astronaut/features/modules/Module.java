package dev.levkush.astronaut.features.modules;
...
public class Module
    ...
    public void enable() {
        ...
        if (HUD.getInstance().notifyToggles.getValue().booleanValue()) {
            TextComponentString text = new TextComponentString(Astronaut.commandManager.getClientMessage() + " " + ChatFormatting.GREEN + this.getDisplayName() + " toggled on.");
    ...
    public void disable() {
        ...
        if (HUD.getInstance().notifyToggles.getValue().booleanValue()) {
            TextComponentString text = new TextComponentString(Astronaut.commandManager.getClientMessage() + " " + ChatFormatting.RED + this.getDisplayName() + " toggled off.");
            Module.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(text, 1);
        }
        this.onToggle();
        this.onDisable();
    ...
    public void setDisplayName(String name) {
        Module module = Astronaut.moduleManager.getModuleByDisplayName(name);
        Module originalModule = Astronaut.moduleManager.getModuleByName(name);
