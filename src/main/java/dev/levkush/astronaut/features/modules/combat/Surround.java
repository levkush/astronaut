...
import dev.levkush.astronaut.util.BlockUtil;
import dev.levkush.astronaut.util.EntityUtil;
...
public class Surround
    ...
    private final dev.levkush.astronaut.util.Timer timer = new dev.levkush.astronaut.util.Timer();
    private final dev.levkush.astronaut.util.Timer retryTimer = new Timer();
    ...
    public void onEnable() {
        ...
        if (this.center.getValue().booleanValue()) {
            Astronaut.positionManager.setPositionPacket((double) this.startPos.getX() + 0.5, this.startPos.getY(), (double) this.startPos.getZ() + 0.5, true, true, true);
        }
        this.retries.clear();
        ...
        for (Vec3d vec3d : vec3ds) {
            ...
            switch (BlockUtil.isPositionPlaceable(position, false)) {
                case 1: {
                    ...
                    if (Astronaut.speedManager.getSpeedKpH() != 0.0 || isExtending || this.extenders >= 1) continue block5;
