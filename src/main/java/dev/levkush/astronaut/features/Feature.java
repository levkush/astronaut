package dev.levkush.astronaut.features;
...
import dev.levkush.astronaut.manager.TextManager;
...
public class Feature
    ...
    public TextManager renderer = Astronaut.textManager;
    private String name;
    ...
    public Setting register(Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof AstronautGui) {
            AstronautGui.getInstance().updateModule((Module) this);
        }
        return setting;
    }
