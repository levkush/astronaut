package dev.levkush.astronaut.features.gui.components;

import dev.levkush.astronaut.Astronaut;
import dev.levkush.astronaut.features.gui.components.items.Item;
import dev.levkush.astronaut.features.gui.components.items.buttons.Button;
...
public class Component
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Astronaut.textManager.drawStringWithShadow(this.getName(), (float) this.x + 3.0f, (float) this.y - 4.0f - (float) AstronautGui.getClickGui().getTextOffset(), -1);
        if (this.open) {
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0 && this.isHovering(mouseX, mouseY)) {
            ...
            AstronautGui.getClickGui().getComponents().forEach(component -> {
                if (component.drag) {
