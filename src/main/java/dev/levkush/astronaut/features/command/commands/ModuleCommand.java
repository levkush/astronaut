...
import dev.levkush.astronaut.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : Astronaut.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : Astronaut.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = Astronaut.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = Astronaut.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
